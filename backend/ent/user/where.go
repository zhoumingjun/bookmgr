...
func HasUploadedFilesWith(preds ...predicate.BookFile) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasReadingProgress() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasReadingProgressWith(preds ...predicate.BookReadingProgress) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasReviewsWith(preds ...predicate.BookReview) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newReviewsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
